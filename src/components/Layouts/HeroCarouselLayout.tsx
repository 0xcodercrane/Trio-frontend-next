...
export default function HeroCarouselLayout({
  ...
  return (
    <div className='bg-ob-purple-darkest-light h-full py-[--section-vertical-padding]'>
      <div className='flex h-full w-full flex-col items-center justify-center gap-8 pt-[var(--header-height)]'>
        <Container padding>
          <div className='flex h-full w-full flex-row items-center justify-center'>
            <div className='bg-ob-purple-darkest-light flex h-full w-1/2 flex-col items-center justify-center gap-8 py-24'>
